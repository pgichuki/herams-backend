...
export default class SurveyCreator extends HTMLElement {
    #shadow;
    ...
    constructor()
    {
        ...
        // const element = this.#shadow.firstElementChild;
        root.innerHTML = `
            <style>
            ...
            <link href="https://surveyjs.io/Content/normalize?v=" type="text/css" rel="stylesheet"></link>
            <link href="https://surveyjs.io/DevBuilds/survey-core/modern.min.css" type="text/css" rel="stylesheet"></link>
            <link href="https://surveyjs.io/DevBuilds/survey-creator-knockout/survey-creator-knockout.min.css" type="text/css" rel="stylesheet"></link>
            <template></template>
            <div></div>
            
        `;
        // Copy the icons into the shadow root.
        const icons = document.querySelector('head svg').cloneNode(true);
        root.querySelector('template').appendChild(icons);
        // debugger;
        Survey.StylesManager.applyTheme("modern");
        creator.render(root.querySelector('div'));
    }


}

customElements.define('survey-creator-test',   SurveyCreator);
